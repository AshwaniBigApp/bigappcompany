                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/faq/edit/'.$faq_id);?>">
                                <div class="form-group"><label class="col-lg-2 control-label">Question</label>
                                    ...
                                    <?php }?>
                                        ...
                                        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                                            <input type="text" name = "question" value="<?php echo $details->question;?>" class="form-control"/>
                                        </div> 
                                    <?php if(form_error('question')){?>
                                    </div>
                                ...
                                <div class="form-group"><label class="col-lg-2 control-label">Content </label>
                                    ...
                                    <?php }?>
                                        ...
                                        <div class="col-lg-12">
                                            <textarea name="answer" class="summernote"><?php echo $details->answer;?></textarea>
                                        </div> 
                                    <?php if(form_error('answer')){?>
                                    </div>
                                    <div class="form-group"><label class="col-lg-2 control-label"></label>
